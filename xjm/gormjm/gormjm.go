...
func (gjm *gjm) AppendJob(cid int64, name, locale, param string) (int64, error) {
	job := &xjm.Job{CID: cid, Name: name, Locale: locale, Param: param, Status: xjm.JobStatusPending}
